...
AdministrationRoute.create!(category: AdministrationRoute.categories[:enteral], name: 'Orally')
AdministrationRoute.create!(category: AdministrationRoute.categories[:enteral], name: 'Sublingually')
AdministrationRoute.create!(category: AdministrationRoute.categories[:enteral], name: 'Rectally')
AdministrationRoute.create!(category: AdministrationRoute.categories[:parenteral_injectable], name: 'IV')
AdministrationRoute.create!(category: AdministrationRoute.categories[:parenteral_injectable], name: 'IM')
AdministrationRoute.create!(category: AdministrationRoute.categories[:parenteral_injectable], name: 'SC')
AdministrationRoute.create!(category: AdministrationRoute.categories[:mucocutaneous], name: 'Otic')
AdministrationRoute.create!(category: AdministrationRoute.categories[:mucocutaneous], name: 'Nasally')
AdministrationRoute.create!(category: AdministrationRoute.categories[:mucocutaneous], name: 'Inhalation')
AdministrationRoute.create!(category: AdministrationRoute.categories[:mucocutaneous], name: 'Cutaneous')
AdministrationRoute.create!(category: AdministrationRoute.categories[:mucocutaneous], name: 'Transdermally')
