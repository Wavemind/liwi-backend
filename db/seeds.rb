...
Node.create!([
  ...
  {label_translations: {"en"=>"Respiratory complaint"}, reference: "1", priority: "mandatory", stage: "triage", type: "Questions::ChiefComplain", diagnostic_id: nil, description_translations: {"en"=>"cough, trouble breathing"}, min_score: 0, algorithm_id: 3, final_diagnostic_id: nil, answer_type_id: 1},
  {label_translations: {"en"=>"Prevention"}, reference: "10", priority: "mandatory", stage: "triage", type: "Questions::ChiefComplain", diagnostic_id: nil, description_translations: {"en"=>""}, min_score: 0, algorithm_id: 3, final_diagnostic_id: nil, answer_type_id: 1},
  {label_translations: {"en"=>"Ear/Nose/Mouth/Throat complaint"}, reference: "2", priority: "mandatory", stage: "triage", type: "Questions::ChiefComplain", diagnostic_id: nil, description_translations: {"en"=>"ear, nose, mouth or thrat pain or secretions"}, min_score: 0, algorithm_id: 3, final_diagnostic_id: nil, answer_type_id: 1},
  {label_translations: {"en"=>"Digestive/gastro-intestinal complaint"}, reference: "3", priority: "mandatory", stage: "triage", type: "Questions::ChiefComplain", diagnostic_id: nil, description_translations: {"en"=>"eg. abdominal pain, diarrhea"}, min_score: 0, algorithm_id: 3, final_diagnostic_id: nil, answer_type_id: 1},
  {label_translations: {"en"=>"Genital/Urinary complaint"}, reference: "4", priority: "mandatory", stage: "triage", type: "Questions::ChiefComplain", diagnostic_id: nil, description_translations: {"en"=>"eg. abnormal urination or secretions from genitals, pain"}, min_score: 0, algorithm_id: 3, final_diagnostic_id: nil, answer_type_id: 1},
  {label_translations: {"en"=>"Eye complaint"}, reference: "5", priority: "mandatory", stage: "triage", type: "Questions::ChiefComplain", diagnostic_id: nil, description_translations: {"en"=>"eg. red eye, pain"}, min_score: 0, algorithm_id: 3, final_diagnostic_id: nil, answer_type_id: 1},
  {label_translations: {"en"=>"Neurological complaint"}, reference: "6", priority: "mandatory", stage: "triage", type: "Questions::ChiefComplain", diagnostic_id: nil, description_translations: {"en"=>"eg. headache, convulsion"}, min_score: 0, algorithm_id: 3, final_diagnostic_id: nil, answer_type_id: 1},
  {label_translations: {"en"=>"Bone or joint pain, accident, burn"}, reference: "7", priority: "mandatory", stage: "triage", type: "Questions::ChiefComplain", diagnostic_id: nil, description_translations: {"en"=>""}, min_score: 0, algorithm_id: 3, final_diagnostic_id: nil, answer_type_id: 1},
  {label_translations: {"en"=>"Skin and hair complaint"}, reference: "8", priority: "mandatory", stage: "triage", type: "Questions::ChiefComplain", diagnostic_id: nil, description_translations: {"en"=>"eg. rash, papules, abscess"}, min_score: 0, algorithm_id: 3, final_diagnostic_id: nil, answer_type_id: 1},
  {label_translations: {"en"=>"Fever"}, reference: "9", priority: "mandatory", stage: "triage", type: "Questions::ChiefComplain", diagnostic_id: nil, description_translations: {"en"=>"fever only"}, min_score: 0, algorithm_id: 3, final_diagnostic_id: nil, answer_type_id: 1},
