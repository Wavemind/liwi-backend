...
z_score = Questions::PhysicalExam.create!(
  ...
  answer_type_id: 3,
  reference_table_x_id: 23,
  # reference_table_y: 0,
  reference_table_male: File.read(File.join(Rails.root, "app/assets/reference_tables/z_score_male_table.json")),
  reference_table_female: File.read(File.join(Rails.root, "app/assets/reference_tables/z_score_female_table.json")),
  is_default: true
)
...
z_score.answers.create!(reference: '3', label_en: 'more than -2 z-score', operator: Answer.operators[:more_or_equal], value: '-2')
