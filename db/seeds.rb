...
drinking_status = Question.create!(answer_type: radio_boolean, label: 'Is the patient able to tolerate PO liquid ?', reference: 'S4', category: Question.categories[:symptom], priority: Question.priorities[:priority])
...
# Answers
Answer.create!(question: age, reference: 'E_1_1', label: '>/=12 months of age', value: '{12}', operator: '{>=}')
Answer.create!(question: age, reference: 'E_1_2', label: '< 6 months of age', value: '{6, 12}', operator: '{>=, <}')
Answer.create!(question: age, reference: 'E_1_3', label: '>/=6 months of age', value: '{2, 6}', operator: '{>=, <}')
Answer.create!(question: age, reference: 'E_1_4', label: '2 months to 5 years', value: '{2}', operator: '{<}')
...
Answer.create!(question: emesis, reference: 'S_5_1', label: '> 3 emesis/over past 24hrs', value: '{3}', operator: '{>=}')
Answer.create!(question: emesis, reference: 'S_5_2', label: '</= 3 emesis/over past 24hrs', value: '{3}', operator: '{<}')
Answer.create!(question: muac, reference: 'P_6_1', label: '> 5 loose stools/over past 24hrs', value: '{12.5}', operator: '{>=}')
Answer.create!(question: muac, reference: 'P_6_2', label: '>/= 3 loose stools/over past 24hrs ', value: '{11.5, 12.5}', operator: '{>=, <}')
Answer.create!(question: muac, reference: 'P_6_3', label: 'looser stools than usual', value: '{11.5}', operator: '{<}')
