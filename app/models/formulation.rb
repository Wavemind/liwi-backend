...
class Formulation < ApplicationRecord
  ...
  enum medication_form: [:tablet, :capsule, :syrup, :suspension, :suppository, :drops, :solution, :powder_for_injection, :patch, :cream, :ointment, :gel, :spray, :inhaler, :pessary, :dispersible_tablet]
