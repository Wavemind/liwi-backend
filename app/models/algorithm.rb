...
class Algorithm < ApplicationRecord
  ...
  def create_reference_table_questions
    ...
    age = questions.create!(label_en: 'Age in months', type: 'Questions::BackgroundCalculation', stage: Question.stages[:registration], is_mandatory: true, answer_type_id: 5, formula: '[ToMonth(VT1)]', is_default: true)
    age.answers.create([
