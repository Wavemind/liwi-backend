...
class Algorithm < ApplicationRecord
  ...
  def create_reference_table_questions
    ...
    age = questions.create!(reference: '2', label_en: 'Age in months', type: 'Questions::Demographic', stage: Question.stages[:registration], priority: Question.priorities[:mandatory], answer_type_id: 3, formula: '[D1]', is_default: true)
    age.answers.create([
