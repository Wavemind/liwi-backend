...
class Algorithm < ApplicationRecord
  ...
  def create_reference_table_questions
    birth_date = questions.create!(reference: '1', label_en: 'Birth date', type: 'Questions::Demographic', stage: Question.stages[:registration], is_mandatory: true, answer_type_id: 6, is_default: true)
    age_in_days = questions.create!(reference: '15', label_en: 'Age in days', type: 'Questions::VitalSignTriage', stage: Question.stages[:triage], is_mandatory: true, answer_type_id: 5, formula: '[ToDay(D_1)]', is_default: true)
    weight = questions.create!(reference: '1', label_en: 'Weight (kg)', type: 'Questions::VitalSignTriage', stage: Question.stages[:triage], is_mandatory: true, answer_type_id: 4, is_default: true)
    hr = questions.create!(reference: '4', label_en: 'Heart rate', type: 'Questions::VitalSignConsultation', stage: Question.stages[:consultation], answer_type_id: 4, is_default: true)
    rr = questions.create!(reference: '5', label_en: 'Respiratory rate', type: 'Questions::VitalSignConsultation', stage: Question.stages[:consultation], answer_type_id: 4, is_default: true)

    age = questions.create!(reference: '2', label_en: 'Age in months', type: 'Questions::Demographic', stage: Question.stages[:registration], is_mandatory: true, answer_type_id: 5, formula: '[ToMonth(D_1)]', is_default: true)
    age.answers.create([
    ...
    z_score = questions.create!(reference: '1', label_en: 'Weight for age (z-score)', type: 'Questions::PhysicalExam', stage: Question.stages[:consultation], is_mandatory: true, answer_type_id: 3, reference_table_x_id: age_in_days.id, reference_table_y_id: weight.id, reference_table_male: "z_score_male_table", reference_table_female: "z_score_female_table", is_default: true)
