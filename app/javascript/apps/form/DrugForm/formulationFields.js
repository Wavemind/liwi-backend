...
export default class FormulationFields extends React.Component {
  constructor(props) {
    ...
    const unity = ["suspension", "syrup", "solution"].includes(values.formulations_attributes[index].medication_form)
      ? "ml"
      : "mg";
    ...
    return (
      <FadeIn>
        ...
        <Form.Row>
          ...
          {(!["capsule", "tablet", "suspension", "syrup", "solution"].includes(formulation.medication_form) || formulation.by_age) ?
          ...
          {(["suspension", "syrup", "solution"].includes(formulation.medication_form) && !formulation.by_age) ?
