class VersionsService
  ...
  def self.extract_final_diagnostic(instance)
    ...
    hash['excluding_final_diagnostics'] = final_diagnostic.excluded_nodes_ids
    hash['excluded_final_diagnostics'] = final_diagnostic.excluding_nodes_ids
  ...
  def self.generate_health_cares
    ...
    @health_cares.each do |key, health_care|
      ...
      hash[health_care.id]['excluding_nodes_ids'] = health_care.excluded_nodes_ids
      hash[health_care.id]['excluded_nodes_ids'] = health_care.excluding_nodes_ids
