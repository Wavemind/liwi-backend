class FinalDiagnosticsController < ApplicationController
  ...
  before_action :set_algorithm, only: [:show, :new, :create, :edit, :update, :add_excluded_diagnostic, :remove_excluded_diagnostic, :destroy]
  before_action :set_version, only: [:show, :new, :create, :edit, :update, :add_excluded_diagnostic, :remove_excluded_diagnostic, :destroy]
