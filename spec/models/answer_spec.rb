...
RSpec.describe Answer, type: :model do
  ...
  it 'accept correct input values' do
    ...
    question = Question.create!(reference: '1', label: 'skin issue', priority: Question.priorities[:basic], category: @category, answer_type: answer_type, algorithm: @algorithm)
