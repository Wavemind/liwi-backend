...
RSpec.describe Answer, type: :model do
  ...
  it 'accept correct input values' do
    ...
    question = Questions::Symptom.create!(reference: '1', label: 'skin issue', priority: Question.priorities[:basic], stage: Question.stages[:triage], answer_type: answer_type, algorithm: @algorithm)
