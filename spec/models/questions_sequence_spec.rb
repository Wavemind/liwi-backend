...
RSpec.describe QuestionsSequence, type: :model do
  ...
  it 'is valid with valid attributes' do
    predefined_syndrome = QuestionsSequences::PredefinedSyndrome.new(reference: '9', label_en: 'skin issue', algorithm: @algorithm)
    expect(predefined_syndrome).to be_valid
  end

  it 'is invalid with invalid attributes' do
    predefined_syndrome = QuestionsSequences::PredefinedSyndrome.new(reference: '9', label_en: nil, algorithm: @algorithm)
  ...
  it 'is invalid same reference' do
    QuestionsSequences::PredefinedSyndrome.create!(reference: '9', label_en: 'skin issue', algorithm: @algorithm)
    predefined_syndrome = QuestionsSequences::PredefinedSyndrome.new(reference: '9', label_en: 'skin issue', algorithm: @algorithm)
  ...
  context 'manual validation' do
    ...
    it 'manual validation returns errors for an invalid diagnostic' do
      Instance.create!(instanceable: @ps5, node: QuestionsSequences::PredefinedSyndrome.create!(reference: '18', label_en: 'skin issue', algorithm: @algorithm))
      @ps5.manual_validate
  ...
  context 'manual validation pss' do
    before(:each) do
      @pss1 = QuestionsSequences::Scored.create!(reference: '1', label_en: 'PSS', algorithm: @algorithm, min_score: 5)
      ps5 = QuestionsSequences::PredefinedSyndrome.create!(reference: '5', label_en: 'diarrhea', algorithm: @algorithm)
      @ps9 = QuestionsSequences::PredefinedSyndrome.create!(reference: '9', label_en: 'skin issue', algorithm: @algorithm)
