...
RSpec.describe QuestionsSequence, type: :model do
  ...
  context 'manual validation' do
    ...
    it 'manual validation returns errors for an invalid diagnostic' do
      Instance.create!(instanceable: @ps5, node: PredefinedSyndrome.create!(reference: '18', label_en: 'skin issue', algorithm: @algorithm))
      @ps5.manual_validate
  ...
  context 'manual validation pss' do
    before(:each) do
      @pss1 = Scored.create!(reference: '1', label_en: 'PSS', algorithm: @algorithm, min_score: 5)
      ps5 = PredefinedSyndrome.create!(reference: '5', label_en: 'diarrhea', algorithm: @algorithm)
      @ps9 = PredefinedSyndrome.create!(reference: '9', label_en: 'skin issue', algorithm: @algorithm)
