module ServiceMacros
  ...
  def create_full_algorithm_version
    before(:each) do
      ...
      s2 = Question.create!(algorithm: epoct, label: 'Cough', reference: '2', type: Symptom, priority: Question.priorities[:mandatory], answer_type: boolean)
      s2_1 = s2.answers.first
      s2_2 = s2.answers.second

      s4 = Question.create!(algorithm: epoct, label: 'Drink as usual', reference: '4', type: Symptom, priority: Question.priorities[:mandatory], answer_type: boolean)
      s4_1 = s4.answers.first
      s4_2 = s4.answers.second

      p1 = Question.create!(algorithm: epoct, label: 'SAO2', reference: '1', type: PhysicalExam, priority: Question.priorities[:mandatory], answer_type: input_integer)
      ...
      p3 = Question.create!(algorithm: epoct, label: 'Respiratory rate', reference: '3', type: PhysicalExam, priority: Question.priorities[:mandatory], answer_type: input_integer)
      ...
      p13 = Question.create!(algorithm: epoct, label: 'Lower chest indrawing', reference: '13', type: PhysicalExam, priority: Question.priorities[:basic], answer_type: boolean)
      p13_1 = p13.answers.first
      p13_2 = p13.answers.second


      p14 = Question.create!(algorithm: epoct, label: 'Sever respiratory distress', reference: '14', type: PhysicalExam, priority: Question.priorities[:basic], answer_type: boolean)
      p14_1 = p14.answers.first
      p14_1 = p14.answers.second

      p25 = Question.create!(algorithm: epoct, label: 'Tolerates PO liquid', reference: '25', type: PhysicalExam, priority: Question.priorities[:basic], answer_type: boolean)
      ...
      ps6 = PredefinedSyndrome.create!(algorithm: epoct, reference: '6', label: 'Able to drink', type: PredefinedSyndrome)
